    ...
    public function dashboard() {
        try {
            ...
            $sqlBirthdays = sprintf("
                SELECT
                    u.pk_user_id AS pk_birthday_id,
                    FORMAT(CAST(u.birth_date AS DATETIME), 'dd ''de'' MMMM', 'es-ES') AS birthday_date,
                ...
                WHERE
                    ...
                    AND MONTH(u.birth_date) = MONTH(GETDATE())
                    AND DAY(u.birth_date) <= DAY(GETDATE())
                ORDER BY
                    DAY(u.birth_date) DESC;
;
            ", UserFiles::TYPE_PROFILE_PICTURE);
